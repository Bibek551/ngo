...
class CountryController extends Controller
{
    ...
    public function store(StoreCountryRequest $request)
    {
        ...
        return redirect()->route('admin.upload.gallery', $country->id);
    }
    ...
    public function destroy(Country $country)
    {
     ...
     public function galleryCountryUpload($country_id)
    {
        $country = Country::findOrFail($country_id);
        $galleries = $country->galleries()->get();
        return view('admin.country.gallery', compact('country_id', 'country','galleries'));
    }

    public function galleryCountryUploadStore(Request $request, $country)
    {
    ...
    public function countryGalleryDelete($image_id)
    {
        $gallery = GalleryCountry::findOrFail($image_id);
