...
class SettingController extends Controller
{
    ...
    public function update(Request $request, Setting $setting)
    {
        ...
        $old_gallery_page_banner = $siteSettings['gallery_page_banner'];
        ...
        if ($gallery_page_banner) {
            $this->removeFile($old_gallery_page_banner);
            $input['gallery_page_banner'] = $gallery_page_banner;
        } else {
            unset($input['gallery_page_banner']);
        }
