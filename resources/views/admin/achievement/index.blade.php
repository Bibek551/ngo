    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <small class="text-muted float-end">
                <a href="{{ route('admin.achievements.create') }}" class="btn btn-primary"><i class="fa-solid fa-plus"></i>
                    Create</a>
            </small>
        </div>
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($achievements as $key => $achievement)
                            <tr>
                                ...
                                <td class="">
                                    <a href="{{ asset('admin/images/achievement') }}/{{ $achievement->image ?: 'avatar.png' }}"
                                ...
                                <td>
                                    ...
                                    <form class="delete-form"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-danger delete_achievement mr-2"
