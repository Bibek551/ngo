...
@section('content')
    ...
    <div class="col-xl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.actions.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-8">
                            <div class="mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="card card-body seo my-3 shadow br-8 p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('seo_schema') is-invalid @enderror" id="" name="seo_schema" cols="30"
                                        rows="5">{{ old('seo_schema') }}</textarea>
                                    @error('seo_schema')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
