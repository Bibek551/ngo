    ...
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit action "{{ $action->title }}"</h5>
                <small class="text-muted float-end">
                    <a class="btn btn-primary" href="{{ route('admin.actions.index') }}"><i class="fa-solid fa-arrow-left"></i>
                        Back</a>
                </small>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('title') is-invalid @enderror" id=""
                                    type="text" value="{{ old('title', $action->title) }}" name="title" placeholder="">
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror ckeditor" id="" name="description"
                                    rows="8" placeholder="">{{ old('description', $action->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                            ...
                            {{-- <div class="mb-3">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror" id="" name="short_description"
                                    rows="4" placeholder="">{{ old('short_description', $action->short_description) }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if ($action->image)
                                        <img class="mt-2 old-image"
                                            src="{{ asset('admin/images/action/' . $action->image) }}" width="100">
                                    @endif
                                    @error('image')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                            ...
                            <div class="card card-body seo my-3 shadow br-8 p-4">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('seo_title') is-invalid @enderror" id=""
                                        type="text" name="seo_title" value="{{ old('seo_title', $action->seo_title) }}"
                                        placeholder="">
                                    @error('seo_title')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('meta_description') is-invalid @enderror" id="" name="meta_description"
                                        rows="5">{{ old('meta_description', $action->meta_description) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('seo_schema') is-invalid @enderror" id="" name="seo_schema"
                                        rows="5">{{ old('seo_schema', $action->seo_schema) }}</textarea>
                                    @error('seo_schema')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('meta_keywords') is-invalid @enderror" id=""
                                        ...
                                        value="{{ old('meta_keywords', $action->meta_keywords) }}" placeholder="">
                                    @error('meta_keywords')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
