                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('title') is-invalid @enderror" id=""
                                    type="text" value="{{ old('title', $blog->title) }}" name="title" placeholder="">
                                @error('title')
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" id=""
                                            type="text" value="{{ old('name', $blog->name) }}" name="name"
                                            placeholder="">
                                        @error('name')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control flatpicker @error('date') is-invalid @enderror"
                                            id="" type="text" value="{{ old('date', $blog->date) }}"
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-6">
                                    ...
                                    @if ($blog->image)
                                        <img class="mt-2 old-image" src="{{ asset('admin/images/blog/' . $blog->image) }}"
                                            width="100">
                                    @endif
                                    @error('image')
                                        <div class="invalid-feedback" style="display: block;">
                            ...
                            <div class="card card-body seo my-3 shadow br-8 p-4">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('seo_title') is-invalid @enderror" id=""
                                        type="text" name="seo_title" value="{{ old('seo_title', $blog->seo_title) }}"
                                        placeholder="">
                                    @error('seo_title')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('meta_description') is-invalid @enderror" id="" name="meta_description"
                                        rows="8">{{ old('meta_description', $blog->meta_description) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('seo_schema') is-invalid @enderror" id="" name="seo_schema"
                                        rows="8">{{ old('seo_schema', $blog->seo_schema) }}</textarea>
                                    @error('seo_schema')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
