    ...
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Demand "{{ $demand->name }}"</h5>
                <small class="text-muted float-end">
                    <a class="btn btn-primary" href="{{ route('admin.demands.index') }}"><i class="fa-solid fa-arrow-left"></i>
                        Back</a>
                </small>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" id=""
                                    type="text" value="{{ old('name', $demand->name) }}" name="name" placeholder="">
                                @error('name')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control @error('order') is-invalid @enderror" type="number"
                                            name="order" value="{{ old('order', $demand->order) }}">
                                        @error('order')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('status') is-invalid @enderror" id=""
                                            name="status">
                                            <option {{ $demand->status == 1 ? 'selected' : '' }} value="1">
                                                Published
                                            </option>
                                            <option {{ $demand->status == 0 ? 'selected' : '' }} value="0">Draft
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback" style="display: block;">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror ckeditor" id="" name="description"
                                    rows="8" placeholder="">{{ old('description', $demand->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror" id="" name="short_description"
                                    rows="4" placeholder="">{{ old('short_description', $demand->short_description) }}</textarea>
                        ...
                        <div class="col-md-4">
                            <div class="card card-body seo my-3 shadow br-8 p-4">
                                <div class="mb-3">
                                    ...
                                    @if ($demand->image)
                                        <img class="mt-2 old-image"
                                            src="{{ asset('admin/images/demand/' . $demand->image) }}" width="100">
                                    @endif
                                    @error('image')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <img class="view-image mt-2" src="" height="60" alt="">
                                    @if ($demand->banner_image)
                                        <img class="mt-2 old-image"
                                            src="{{ asset('admin/images/demand/' . $demand->banner_image) }}"
                                            width="100">
                                    @endif
                                    @error('banner_image')
                                        <div class="invalid-feedback" style="display: block;">
                            ...
                            <div class="card card-body seo my-3 shadow br-8 p-4">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('seo_title') is-invalid @enderror" id=""
                                        type="text" name="seo_title" value="{{ old('seo_title', $demand->seo_title) }}"
                                        placeholder="">
                                    @error('seo_title')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('meta_description') is-invalid @enderror" id="" name="meta_description"
                                        rows="6">{{ old('meta_description', $demand->meta_description) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('meta_keywords') is-invalid @enderror"
                                        ...
                                        value="{{ old('meta_keywords', $demand->meta_keywords) }}" placeholder="">
                                    @error('meta_keywords')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
